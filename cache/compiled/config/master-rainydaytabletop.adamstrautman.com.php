...
return [
    ...
    'timestamp' => 1637823607,
    'checksum' => '4ddee800b376b4474f775ffa35bfe869',
    'files' => [
        'user/config' => [
            'media' => [
...
node_modules'
        ...
        'site' => [
            'title' => 'Rainy Day Tabletop',
            'default_lang' => 'en',
            'author' => [
                'name' => 'Adam Strautman',
                'email' => 'adam@rainydaytabletop.com'
            ],
            'taxonomies' => [
                0 => 'category',
                1 => 'tag'
            ...
            'metadata' => [
                'description' => 'We are a group of friends that comes together to play tabletop games, and then records it!'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
