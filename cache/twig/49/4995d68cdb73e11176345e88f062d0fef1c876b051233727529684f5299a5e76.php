...
class __TwigTemplate_fbdc0ba4a764e2181826627c0ddeb4fb534c59c74bfa3a501234895d52c2eec4 extends \Twig\Template
{
...
($context["directory_config"] ?? null), "order", []), "by", []), "direction" => $this->getAttribute($this->getAttribute(($context["directory_config"] ?? null), "order", []), "dir", [])]], "searchPlaceholder" => $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.RESOURCE_FILTER"), "paginationInfo" => $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_FLEX_OBJECTS.LIST_INFO"), "emptyResult" => $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_FLEX_OBJECTS.EMPTY_RESULT")]), "html_attr");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            ...
            echo twig_escape_filter($this->env, (200 * twig_random($this->env, [0 => 0.6999999999999999555910790149937383830547332763671875, 1 => 0.8000000000000000444089209850062616169452667236328125, 2 => 0.90000000000000002220446049250313080847263336181640625, 3 => 1])), "html", null, true);
            echo "\" height=\"12\"></rect>
                        <rect x=\"533\" y=\"";
            // line 83
            echo twig_escape_filter($this->env, ((31 * $context["i"]) + 10), "html", null, true);
            echo "\" rx=\"6\" ry=\"6\" width=\"";
            echo twig_escape_filter($this->env, (63 * twig_random($this->env, [0 => 0.6999999999999999555910790149937383830547332763671875, 1 => 0.8000000000000000444089209850062616169452667236328125, 2 => 0.90000000000000002220446049250313080847263336181640625, 3 => 1])), "html", null, true);
            echo "\" height=\"12\"></rect>
                        <rect x=\"653\" y=\"";
            // line 84
            echo twig_escape_filter($this->env, ((31 * $context["i"]) + 10), "html", null, true);
            echo "\" rx=\"6\" ry=\"6\" width=\"";
            echo twig_escape_filter($this->env, (78 * twig_random($this->env, [0 => 0.6999999999999999555910790149937383830547332763671875, 1 => 0.8000000000000000444089209850062616169452667236328125, 2 => 0.90000000000000002220446049250313080847263336181640625, 3 => 1])), "html", null, true);
            echo "\" height=\"12\"></rect>
                        <rect x=\"755\" y=\"";
            // line 85
            echo twig_escape_filter($this->env, ((31 * $context["i"]) + 10), "html", null, true);
            echo "\" rx=\"6\" ry=\"6\" width=\"";
            echo twig_escape_filter($this->env, (117 * twig_random($this->env, [0 => 0.6999999999999999555910790149937383830547332763671875, 1 => 0.8000000000000000444089209850062616169452667236328125, 2 => 0.90000000000000002220446049250313080847263336181640625, 3 => 1])), "html", null, true);
            echo "\" height=\"12\"></rect>
                        <rect x=\"938\" y=\"";
            // line 86
            echo twig_escape_filter($this->env, ((31 * $context["i"]) + 10), "html", null, true);
            echo "\" rx=\"6\" ry=\"6\" width=\"";
            echo twig_escape_filter($this->env, (83 * twig_random($this->env, [0 => 0.6999999999999999555910790149937383830547332763671875, 1 => 0.8000000000000000444089209850062616169452667236328125, 2 => 0.90000000000000002220446049250313080847263336181640625, 3 => 1])), "html", null, true);
            echo "\" height=\"12\"></rect>
...
{% endblock %}
", "flex-objects/types/default/list/list.html.twig", "/home/n1d1015/rainydaytabletop.com/user/plugins/flex-objects/admin/templates/flex-objects/types/default/list/list.html.twig");
    }
}
